...
uint32_t PumpsSetSpeed(uint8_t channel, uint16_t value)
{
	...
	{
	case 0:
		GPIOSetValue(PUMPS_PORT, PUMPS_1_BIT, (value !=0 ));
		break;
	case 1:
		GPIOSetValue(PUMPS_PORT, PUMPS_2_BIT, (value !=0 ));
		break;
	case 2:
		GPIOSetValue(PUMPS_PORT, PUMPS_3_BIT, (value !=0 ));
		break;
	case 3:
		GPIOSetValue(PUMPS_PORT, PUMPS_4_BIT, (value !=0 ));
		break;
	case 4:
		GPIOSetValue(PUMPS_PORT, PUMPS_5_BIT, (value !=0 ));
		break;
	case 5:
		GPIOSetValue(PUMPS_PORT, PUMPS_6_BIT, (value !=0 ));
		break;
	case 6:
		GPIOSetValue(PUMPS_PORT, PUMPS_7_BIT, (value !=0 ));
		break;
	case 7:
		GPIOSetValue(PUMPS_PORT, PUMPS_8_BIT, (value !=0 ));
		break;
	default:
		break;
	}
