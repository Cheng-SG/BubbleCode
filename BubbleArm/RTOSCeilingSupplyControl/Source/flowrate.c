...
void TIMER32_1_IRQHandler(void)
{
	...
	if (LPC_TMR32B1 ->IR & 0x01)
	{
		...
		if (Flowrate[(PANEL1_SUPPLY_FLOWRATE_CHANNEL - 1)]
				> Flowrate[(PANEL1_MIX_FLOWRATE_CHANNEL - 1)]
				|| Flowrate[(PANEL1_RECYCLE_FLOWRATE_CHANNEL - 1)]
						> Flowrate[(PANEL1_MIX_FLOWRATE_CHANNEL - 1)])
		{
			if (Flowrate[(PANEL1_SUPPLY_FLOWRATE_CHANNEL - 1)]
					> Flowrate[(PANEL1_RECYCLE_FLOWRATE_CHANNEL - 1)])
				...
				Flowrate[(PANEL1_SUPPLY_FLOWRATE_CHANNEL - 1)] =
						-Flowrate[(PANEL1_SUPPLY_FLOWRATE_CHANNEL - 1)];
		}
		if (Flowrate[(PANEL2_SUPPLY_FLOWRATE_CHANNEL - 1)]
				> Flowrate[(PANEL2_MIX_FLOWRATE_CHANNEL - 1)]
				|| Flowrate[(PANEL2_RECYCLE_FLOWRATE_CHANNEL - 1)]
						> Flowrate[(PANEL2_MIX_FLOWRATE_CHANNEL - 1)])
		{
			if (Flowrate[(PANEL2_SUPPLY_FLOWRATE_CHANNEL - 1)]
					> Flowrate[(PANEL2_RECYCLE_FLOWRATE_CHANNEL - 1)])
				...
				Flowrate[(PANEL2_SUPPLY_FLOWRATE_CHANNEL - 1)] =
						-Flowrate[(PANEL2_SUPPLY_FLOWRATE_CHANNEL - 1)];
		}
