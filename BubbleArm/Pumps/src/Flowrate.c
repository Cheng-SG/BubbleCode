...
void PIOINT2_IRQHandler(void)
{
  ...
  if ( regVal & (0x1<<FLOWRATE_1_BIT) )count[0]++;
  if ( regVal & (0x1<<FLOWRATE_2_BIT) )count[1]++;
  if ( regVal & (0x1<<FLOWRATE_3_BIT) )count[2]++;
  if ( regVal & (0x1<<FLOWRATE_4_BIT) )count[3]++;
  if ( regVal & (0x1<<FLOWRATE_5_BIT) )count[4]++;
  if ( regVal & (0x1<<FLOWRATE_6_BIT) )count[5]++;
  if ( regVal & (0x1<<FLOWRATE_7_BIT) )count[6]++;
  if ( regVal & (0x1<<FLOWRATE_8_BIT) )count[7]++;
