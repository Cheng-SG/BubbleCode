...
#define DATA_SEND_TASK_PRIORITY  ( tskIDLE_PRIORITY + 3 )
#define DATA_SEND_TASK_STACK_SIZE   (100)
#define DATA_SEND_FREQUENCY      ( 1 )
#define DATA_SEND_TASK_PARAMETER	 ( 0x3333UL )

#define SENSOR_TASK_PRIORITY     ( tskIDLE_PRIORITY + 2 )
#define SENSOR_TASK_STACK_SIZE   (100)
#define SENSOR_SCAN_FREQUENCY    (20)
#define SENSOR_SCAN_PARAMETER	 ( 0x2222UL )
