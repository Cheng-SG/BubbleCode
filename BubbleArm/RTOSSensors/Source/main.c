...
extern void prvSensorsScanTask( void *pvParameters );
...
int main( void )
{
	...
	xTaskCreate( prvSensorsScanTask,					/* The function that implements the task. */
						...
						( void * ) SENSOR_SCAN_PARAMETER, /* The parameter passed to the task - just to check the functionality. */
